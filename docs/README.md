...
| เอกสาร | เนื้อหา |
|--------|---------|
| [architech.md](./architech.md) | Tech stack, flow / use case / ข้อมูล, diagram, **Node + npm กับ Bun** (trade-off เครื่องมือ frontend) |
...
| [planning.md](./planning.md) | แผนอนาคต, เป้าหมายระยะยาว (scale / deploy), การผสาน FE/BE |
| [testing.md](./testing.md) | แนวทางทดสอบและบันทึกการรัน |
